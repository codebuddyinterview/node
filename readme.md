...
# Note
1. Run `npm run test` to run the test cases. **All test cases should pass in your final submit otherwise the task is considered as incomplete.**
2. `npm run seeder` creates 100 users and 2 posts per user. Use this seeder to populate the database. 
